...
//        System.out.println("添加水印文字完成!");
    ...
    public static void main(String[] args) {
        int width = 800;
        int height = 600;
        Font font = new Font("微软雅黑", Font.CENTER_BASELINE, 40);//字体
        BufferedImage bi1 = waterMarkByText(width, height, "测试aB~12十五个字—超能局", Color.GRAY, font, -30d,
                0.2f);//给图片添加文字水印
//        BufferedImage bi = waterMarkByText(width, height, "测试aB~,", Color.GRAY, -30d,
//                0.2f);//给图片添加文字水印
//        BufferedImage bi2 = waterMarkByText(width, height, "测试aB~,");//给图片添加文字水印
//        BufferedImage bi3 = waterMarkByText("测试aB~,");
        try {
            ImageIO.write(bi1, "png", new File("D:/workSpace/Java-Tutorials/lib-poi-tl/src/main/resources/test.png"));//写入文件
